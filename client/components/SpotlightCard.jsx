    ...
    <div className="mt-32">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-xl max-w-4xl mx-auto leading-relaxed">
              Stay up to date with the most exciting esports events and tournaments happening around the world.
            </p>
          </div>
    <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                image: "https://ik.imagekit.io/Prahlad2002/S8UL/media3.png?updatedAt=1753125940610",
              ...
              <div key={index} className="group relative bg-gradient-to-br from-s8ul-dark-lighter to-gray-800/50 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border border-s8ul-gray/20">
