...
const Navigation = ({ className }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "md:hidden overflow-y-auto transition-all duration-500 ease-in-out scrollbar-none",
          isMenuOpen
            ? "max-h-screen bg-s8ul-dark/95 backdrop-blur-lg border-b border-s8ul-green/20 shadow-2xl"
            : "max-h-0",
        )}
      >
